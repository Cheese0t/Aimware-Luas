...
--local advancedgroup = gui.Groupbox(ref, "Advanced Settings", 16, 155)
text1:SetPosY(-25)
...
local settings = {
	enemy = {
	   	vis = {
			...
			overlay = gui.Combobox(group, "enemy.vis.overlay", "Overlay", "Off", "Glow", "Wireframe", "Wireframe glow"),
	   	...
	   	iz = {
			...
			overlay = gui.Combobox(group, "enemy.iz.overlay", "Overlay", "Off", "Glow", "Wireframe", "Wireframe glow"),
		...
		attvis = {
			...
			overlay = gui.Combobox(group, "enemy.attvis.overlay", "Overlay", "Off", "Glow", "Wireframe", "Wireframe glow"),
	   	...
	   	attiz = {
			...
			overlay = gui.Combobox(group, "enemy.attiz.overlay", "Overlay", "Off", "Glow", "Wireframe", "Wireframe glow"),
   ...
   friend = {
	   	vis = {
			...
			overlay = gui.Combobox(group, "friend.vis.overlay", "Overlay", "Off", "Glow", "Wireframe", "Wireframe glow"),
	   	...
	   	iz = {
			...
			overlay = gui.Combobox(group, "friend.iz.overlay", "Overlay", "Off", "Glow", "Wireframe", "Wireframe glow"),
	   	...
	   	attvis = {
			...
			overlay = gui.Combobox(group, "friend.attvis.overlay", "Overlay", "Off", "Glow", "Wireframe", "Wireframe glow"),
	   	...
	   	attiz = {
			...
			overlay = gui.Combobox(group, "friend.attiz.overlay", "Overlay", "Off", "Glow", "Wireframe", "Wireframe glow"),
   ...
   loc = {
	   	vis = {
			...
			overlay = gui.Combobox(group, "loc.vis.overlay", "Overlay", "Off", "Glow", "Wireframe", "Wireframe glow"),
		...
		iz = {
			...
			overlay = gui.Combobox(group, "loc.iz.overlay", "Overlay", "Off", "Glow", "Wireframe", "Wireframe glow"),
	   	...
	   	attvis = {
			...
			overlay = gui.Combobox(group, "loc.attvis.overlay", "Overlay", "Off", "Glow", "Wireframe", "Wireframe glow"),
		...
		attiz = {
			...
			overlay = gui.Combobox(group, "loc.attiz.overlay", "Overlay", "Off", "Glow", "Wireframe", "Wireframe glow"),
	...
	viewmodel = {
		arms = {
			...
			overlay = gui.Combobox(group, "vm.arms.overlay", "Overlay", "Off", "Glow", "Wireframe", "Wireframe glow"),
		...
		weapon = {
			...
			overlay = gui.Combobox(group, "vm.attiz.overlay", "Overlay", "Off", "Glow", "Wireframe", "Wireframe glow"),
...
local function CheckChanges()
	...
	if menuref:IsActive() then
		...
		cache.pearl ~= setting.pearl:GetValue() then
		...
		cache.glowz ~= setting.glowz:GetValue() then
